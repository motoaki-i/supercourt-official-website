...
<tr>
<th>希望ホーム<br class="pcbr"><span class="hissu">第一希望のみ必須</span></th>
<td>
<ul class="homelist">
<li class="clearfix">
<p>第一希望<span class="hissu">必須</span></p>
<div><?php include( $_SERVER['DOCUMENT_ROOT'] . '/_area1-data-request.php'); ?></div>
</li>
<li class="clearfix">
<p>第二希望</p>
<div><?php include( $_SERVER['DOCUMENT_ROOT'] . '/_area2.php'); ?></div>
</li>
<li class="clearfix">
<p>第三希望</p>
<div><?php include( $_SERVER['DOCUMENT_ROOT'] . '/_area3.php'); ?></div>
</li>
</ul>
</td>
</tr>
                  ...
                  <tr>
                    <th>ご質問</th>
                    <td>
                      <textarea name="ご質問" rows="10" cols="45" style="height: 120px; width: 80%"></textarea>
                    </td>
                  </tr>
