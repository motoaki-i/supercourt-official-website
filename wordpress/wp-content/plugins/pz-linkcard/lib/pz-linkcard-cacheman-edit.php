...
<form method="post">
	...
	<span class="pz-lkc-man-cache-editor-title"><span class="pz-lkc-man-cache-editor-icon"><?php echo __('&#x1f4dd;&#xfe0f;', $this->text_domain ); ?></span>&ensp;<span class=" class="pz-lkc-man-cache-editor-text"><?php echo __('Cache Editor', $this->text_domain ); ?></span></span>
