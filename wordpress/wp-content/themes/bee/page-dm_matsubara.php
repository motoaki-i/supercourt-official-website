...
<div class=""><h1>スーパー・コート<br class="spdisp">松原&nbsp;リンク集</h1></div>
<section class="lplinks">
<ul class="lplinkslist">
<li><a href="<?php echo get_permalink(10136); ?>#form" target="blank">資料請求・見学申込・お問合せフォーム<span class="snsicon"><img alt="お問い合わせ" src="https://www.supercourt.jp/images/snsicon-supercourt.webp"></span></a></li>
<li><a href="<?php echo get_permalink(10136); ?>" target="blank">施設公式ホームページ<span class="snsicon"><img alt="スーパー・コート公式" src="https://www.supercourt.jp/images/snsicon-supercourt.webp"></span></a></li>
<li><a href="https://www.supercourt.jp/blog/matsubara/" target="blank">施設公式ブログ<span class="snsicon"><img alt="スーパー・コート公式" src="https://www.supercourt.jp/images/snsicon-supercourt.webp"></span></a></li>
<li><a href="https://search.google.com/local/reviews?placeid=ChIJAQAwjQLZAGARVGjt855F5EA" target="blank">Googleクチコミ<span class="snsicon"><img alt="Googleクチコミ" src="https://www.supercourt.jp/images/snsicon-googlereview.webp"></span></a></li>
<li><a href="https://www.google.com/maps/search/?api=1&query=Google&query_place_id=ChIJAQAwjQLZAGARVGjt855F5EA" target="blank">Googleマップ<span class="snsicon"><img alt="Googleマップ" src="https://www.supercourt.jp/images/snsicon-googlemap.webp"></span></a></li>
