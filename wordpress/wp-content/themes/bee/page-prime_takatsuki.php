...
<div class="lp-mv relative">
  <figure class="lp-mv-image">
    <img src="<?php bloginfo('template_directory');?>/assets/image/facility/prime/mv_prime_riha.webp" alt="">
  </figure>
  <div class="ttl-lp-wrap bg-gold-gradiate relative">
    ...
    <h1 class="ttl-lp-jp txt-white  txt-medium">介護付き有料老人ホーム｜高槻市<br>スーパー・コート プライム高槻</h1>
    <p class="ttl-lp-open">2026年<br><span>10</span>月<br>プライム施設へ<br>リニューアル</p>
  </div>
</div>
...
<section class="scfacility-blog mt2 space-s-bottom">
    ...
    <div class="scfacility-blog__cont__wrap mt2">
        <?php
            // 表示したいブログのURLを直接指定
            $base_url = 'https://www.supercourt.jp/blog/takatsuki/';
    ...
    <div class="scfacility-btn__wrap">
        <?php $blog_url = 'https://www.supercourt.jp/blog/takatsuki/'; ?>
 ...
 */
$manual_event_slug = 'news-event-takatsuki'; // ← ここを表示したいスラッグに書き換える
?>
...
<section id="olive-point" class="bg-beige relative">
  ...
  <div class="olive-point-wrap bg-white space-m space-3s-bottom wrap-l-right">
    ...
    <p class="bg-beige1 p1 txt-bold txt-center">※24時間看護体制、専門職による個別リハビリは10月以降にサービス開始予定です。</p>
    </div>
  ...
  <figure class="mb1"><img src="<?php bloginfo('template_directory');?>/assets/image/facility/prime/prime-main-nursing.webp" alt="専門リハビリ"></figure>
    <div class="mt2">
      <div class="">
        ...
        <p class="bg-beige1 p1">痰吸引や胃瘻などの処置が必要な方でも安心してご利用いただけます。<br><span class="txt-bold">※24時間看護体制は10月以降にサービス開始予定です。</span></p>
    </div>
    </div>
</div>
</section>
  ...
  <figure class="mb1"><img src="<?php bloginfo('template_directory');?>/assets/image/facility/prime/prime-main-rihabiti.webp" alt="専門リハビリ"></figure>
    <div class="mt2">
      <div class="">
        ...
        <p class="bg-beige1 p1">理学療法士監修によるリハビリをご提供いたします。退院(入居)後、30日間は週5回、31日目以降は週3回リハビリを受けることができます。<br><span class="txt-bold">※専門職による個別リハビリは10月以降にサービス開始予定です。</span></p>
...
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E3%83%AA%E3%83%8F%E3%83%93%E3%83%AA%E3%82%A4%E3%83%A1%E3%83%BC%E3%82%B8.jpg.webp" alt="リハビリ"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">リハビリ</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E9%AB%98%E6%A7%BB-17.jpg.webp" alt="レストラン"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">レストラン</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E9%AB%98%E6%A7%BB-4.jpg.webp" alt="浴室・天然温泉"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">浴室・天然温泉</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E9%AB%98%E6%A7%BB-5.jpg.webp" alt="機械浴"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">機械浴</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E9%AB%98%E6%A7%BB-15.jpg.webp" alt="エントランス"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">エントランス</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E9%AB%98%E6%A7%BB-19.jpg.webp" alt="駐車場"></figure>
...
<section>
  <div class="lp-price-wrap wrap-m bg-gold-gradiate space-3s space-m-bottom">
    ...
    　<div class="grid2 gg1 mb2">
        ...
        <div class="bg-white txt-center p1">
          <p class="txt-medium"><span class="pi1 txt-bold">月額利用料</span><br class="sp-only"><span class="big txt-en txt-gold ">342,096</span>円（税込）</p>
        </div>
      </div>

      <div class="bg-beige1 p1 mt1">［ 入居対象 ］　要支援1　要支援2　要介護1　要介護2　要介護3　要介護4　要介護5</div>
      <p class="txt-jp-s mt1">※ご利⽤料⾦は1⽇3⾷、⾷事代含んでおります。<br>※リハビリ費用はご利⽤料⾦に含んでおります。<br>※個室内電気代が別途必要となります。<br>※介護保険、医療保険適用による負担額が別途必要となります。</p>
    </div>
  </div>
...
<section class="space-m space-2l-bottom bg-beige">
  <div class="maw-880">
    ...
    <table class="facility-overview-table">
      ...
      <tr>
        <th>所在地</th>
        <td>大阪府高槻市南庄所町14番4号</td>
      </tr>
      <tr>
        <th>電話番号</th>
        <td>施設直通 ： <a href="tel:072-672-4850">072-672-4850</a><br>入居相談 ： <a href="tel:0120-532-029">0120-532-029</a></td>
      </tr>
      <tr>
        <th>規模・構造</th>
        <td>S造地上3階建</td>
      ...
      <tr>
        <th>最寄駅</th>
        <td>JR京都線「高槻」駅・阪急京都線「高槻市」駅より市営バス②番のりば柱本団地行「東庄所」下車、徒歩約5分<br>JR京都線「高槻」駅・阪急京都線「高槻市」駅より市営バス③番のりば富田団地行「東庄所」下車、徒歩約5分</td>
      </tr>
      <tr>
        <th>開設日</th>
        <td>平成24年9月1日</td>
...
<section class="lp-access">
  <div class="lp-access-wrap bg-gold-gradiate wrap-m space-3s space-m-bottom">
    ...
    <div class="maw-880">
      <div class="lp-gmap">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10898.941289159866!2d135.60869743890268!3d34.83613933723065!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60011d4edf26235d%3A0xbb3e29e18cf43b5c!2z5pyJ5paZ6ICB5Lq644Ob44O844OgIOOCueODvOODkeODvOODu-OCs-ODvOODiOmrmOanuw!5e1!3m2!1sja!2sus!4v1778927972430!5m2!1sja!2sus" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
      <p class="txt-jp-l txt-medium middle txt-white mt2 mb2">JR京都線「高槻」駅・阪急京都線「高槻市」駅より市営バス②番のりば柱本団地行「東庄所」下車、徒歩約5分<br>〒569-0063　<br class="sp-only">大阪府高槻市南庄所町14番4号<br>TEL：<a href="tel:0120-532-029">0120-532-029</a>（通話料無料ご入居相談窓口）</p>
...
<figure>
<img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/10/施設長写真_0027_鍵本　貢一.jpg" alt="画像">
</figure>
<p class="fontM txt-just">こんにちは。介護付有料老人ホーム スーパー・コート高槻は、2012年9月1日にオープンしました。<br>
芥川沿いの閑静な住宅街となっておりますので、落ち着いた環境でお過ごしいただけます。<br>
春には、施設横の土手沿いに桜が満開となり、中庭に面した食堂からも眺めることが出来ますので、お食事の時間でも楽しめる環境になっています。<br>
歳を重ねるごとに身体の自由が利かなくなったり、物事の判断に時間がかかったりします。昔は簡単に出来ていたことが出来なくなり、時にはあきらめたりつらい思いをすることがあります。私たち職員は、そうしたご入居者の思いに寄り添ってゆけるよう、心のこもった介護・看護を行っており、笑顔溢れる活気のある施設をこれからも目指してまいります。<br>
お近くに来られた際は、ぜひお気軽にお立ち寄りくださいませ。<br>
施設見学や入居相談なども随時行っております。皆様のお越しを心よりお待ち申し上げております。 </p>
</div>
</div>
</section>
...
<section class="space-s space-2l-bottom bg-beige">
  <div class="lp-blog-wrap bg-white maw-960 grid align-center space-3s space-3s-bottom">
    ...
    <div>
      ...
      <p class="mt2 txt-center"><a class="lp-blog-more relative" href="https://www.supercourt.jp/blog/takatsuki/" target="_blank">詳しく見る</a></p>
    </div>
  </div>
</section>
