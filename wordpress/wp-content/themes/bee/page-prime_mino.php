...
<div class="lp-mv relative">
  <figure class="lp-mv-image">
    <img src="<?php bloginfo('template_directory');?>/assets/image/facility/prime/mv_primemino.webp" alt="">
  </figure>
  <div class="ttl-lp-wrap bg-gold-gradiate relative">
    ...
    <h1 class="ttl-lp-jp txt-white  txt-medium">有料老人ホーム｜箕面市<br>スーパー・コート プライム箕面</h1>
...
<section class="scfacility-blog mt2 space-s-bottom">
    ...
    <div class="scfacility-blog__cont__wrap mt2">
        <?php
            // 表示したいブログのURLを直接指定
            $base_url = 'https://www.supercourt.jp/blog/mino/';
    ...
    <div class="scfacility-btn__wrap">
        <?php $blog_url = 'https://www.supercourt.jp/blog/mino/'; ?>
 ...
 */
$manual_event_slug = 'news-event-minoonohara'; // ← ここを表示したいスラッグに書き換える
?>
    ...
    <div class="wrap-m grid2 gg2">
      ...
      <div class="">
          <figure class="mb1"><img src="<?php bloginfo('template_directory');?>/assets/image/facility/prime/prime-thumb-onsen.webp" alt="point04"></figure>
           <h3 class="ttl-premiumolive-point ttl-jp-l txt-bold txt-gold">本物の天然温泉がある<br>週2回の特別な寛ぎ</h3>
      </div>
      <div class="">
...
<div class="wrap-m">
  <figure class="mb1"><img src="<?php bloginfo('template_directory');?>/assets/image/facility/prime/prime-main-meal2.webp" alt="こだわり食材のメニュー豊かなお食事"></figure>
    <div class="mt2">
      <div class="">
        <h3 class="txt-center ttl-jp-2l txt-bold mb1 txt-gold">こだわりの食材が彩る<br>ワンランク上のお食事</h3>
        <p class="space-3s-bottom">食は毎日の楽しみであり、生きる力そのものです。旬の食材を活かした、見た目にも美しいごだわりのお食事をご提供。和・洋・中のバラエティ豊かなメニューは、いつもの食卓を豊かに彩ります。また、咀嚼や嚥下が難しい方には、専門スタッフが一人ひとりの状態に合わせて食事形態を工夫。食べる喜びを諦めることなく、美味しく安全なお食事をお楽しみいただけます。</p>
...
<div class="wrap-m">
  <figure class="mb1"><img src="<?php bloginfo('template_directory');?>/assets/image/facility/prime/prime-main-onsen.webp" alt="専門リハビリ"></figure>
    <div class="mt2">
      <div class="">
        <h3 class="txt-center ttl-jp-2l txt-bold mb1 txt-gold">自宅に本物の天然温泉がある<br>日々を特別なものにする<br>週2回の心地よい寛ぎ</h3>
        <p class="mb2">日々の暮らしそのものが、心と体を癒す時間であってほしい。私たちはそう考えます。<br>リフレッシュと活力を育む週2回のバスタイムでは、当ホームにいながら本物の天然温泉で心ゆくまでおくつろぎいただけます。洗練された住空間と、きめ細やかなサービスの中で、満ち足りた毎日をお過ごしください。</p>
        <p class="bg-beige1 p1">当社グループのスーパーホテル大阪天然温泉より本物の天然温泉を搬入。週2回の天然温泉で身も心もリフレッシュして下さい。</p>
    </div>
    </div>
</div>
</section>
...
<div class="wrap-m">
  <figure class="mb1"><img src="<?php bloginfo('template_directory');?>/assets/image/facility/prime/prime-main-nursing.webp" alt="専門リハビリ"></figure>
    <div class="mt2">
      <div class="">
        <h3 class="txt-center ttl-jp-2l txt-bold mb1 txt-gold">看護師が24時間生活をサポート</h3>
        <p class="mb2">24時間体制で看護師が日常の健康管理のほか、点滴や胃ろう、痰の吸引、インスリン投与などにも対応します。</p>
  ...
  <figure class="mb1"><img src="<?php bloginfo('template_directory');?>/assets/image/facility/prime/prime-main-rihabiti.webp" alt="専門リハビリ"></figure>
    <div class="mt2">
      <div class="">
        ...
        <p class="bg-beige1 p1">理学療法士監修によるリハビリをご提供いたします。退院(入居)後、30日間は週5回、31日目以降は週3回リハビリを受けることができます。</p>
...
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2026/08/prme-mino_dining.webp" alt="レストラン"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">レストラン</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2022/12/%E7%AE%95%E9%9D%A2%E5%B0%8F%E9%87%8E%E5%8E%9F%E3%83%AA%E3%83%8E%E3%83%99_2.jpg.webp" alt="リハビリ専用スペース"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">リハビリ専用スペース</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2026/08/prme-mino_reharoom2.webp" alt="リハビリ専用スペース"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">リハビリ専用スペース</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2022/12/%E7%AE%95%E9%9D%A2%E5%B0%8F%E9%87%8E%E5%8E%9F%E3%83%AA%E3%83%8E%E3%83%99_3.jpg.webp" alt="免荷装置・トレッドミル"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">免荷装置・トレッドミル</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2026/08/prme-mino_rihaalcorveg.webp" alt="リハビリ専用スペース"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">リハビリ専用スペース前廊下</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2022/12/%E7%AE%95%E9%9D%A2%E5%B0%8F%E9%87%8E%E5%8E%9F%E3%83%AA%E3%83%8E%E3%83%99_4.jpg.webp" alt="リハビリ機器"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">リハビリ機器</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2022/12/%E7%AE%95%E9%9D%A2%E5%B0%8F%E9%87%8E%E5%8E%9F%E3%83%AA%E3%83%8E%E3%83%99_5.jpg.webp" alt="リハビリ機器"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">リハビリ機器</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2026/08/prme-mino_bathroom.webp" alt="天然温泉"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">天然温泉</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2026/08/prme-mino_bathroom2.webp" alt="大浴場"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">大浴場</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2026/08/prme-mino_secondflooralcorveg.webp" alt="談話スペース"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">2階廊下・談話スペース</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2026/08/prme-mino_walllogo.webp" alt="エントランス"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">エントランス</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E7%AE%95%E9%9D%A2%E5%B0%8F%E9%87%8E%E5%8E%9F-16.jpg.webp" alt="駐車場"></figure>
...
<section>
  <div class="lp-price-wrap wrap-m bg-gold-gradiate space-3s space-m-bottom">
    ...
    　<div class="grid2 gg1 mb2">
        ...
        <div class="bg-white txt-center p1">
          <p class="txt-medium"><span class="pi1 txt-bold">月額利用料</span><br class="sp-only"><span class="big txt-en txt-gold ">365,724</span>円（税込）</p>
        </div>
      </div>
    ...
    <div class="grid2 gg1">
        ...
        <div class="bg-white txt-center p1">
          <p class="txt-medium"><span class="pi1 txt-bold">月額利用料</span><br class="sp-only"><span class="big txt-en txt-gold ">185,724</span>円（税込）</p>
        </div>
      </div>
      <div class="bg-beige1 p1 mt1">
      ［ 入居対象 ］　●がん末期の方　●パーキンソン病　●多発性硬化症　●重症筋無力症　●筋萎縮性側索硬化症(ALS)　●脊髄小脳変性症　●多系統萎縮症　●脊髄性筋萎縮症　●頚髄損傷　●人工呼吸器を使用している状態の方<br>
...
<section class="space-m space-2l-bottom bg-beige">
  <div class="maw-880">
    ...
    <table class="facility-overview-table">
      ...
      <tr>
        <th>所在地</th>
        <td>大阪府箕面市小野原西6丁目14番15号</td>
      </tr>
      <tr>
        <th>電話番号</th>
        <td>施設直通 ： <a href="tel:072-726-4850">072-726-4850</a><br>入居相談 ： <a href="tel:0120-532-029">0120-532-029</a></td>
      </tr>
      <tr>
        <th>規模・構造</th>
        <td>鉄筋コンクリート造地上3階建</td>
      </tr>
      <tr>
        <th>居室数</th>
        <td>56室</td>
      ...
      <tr>
        <th>最寄駅</th>
        <td>阪急千里線「北千里」駅より徒歩約20分<br>阪急千里線「北千里」駅より阪急バス「小野原南」下車、徒歩約2分（175・176系統）<br>北大阪急行「千里中央」駅より阪急バス「小野原南」下車、徒歩2分（12番乗り場175・176系統）</td>
      </tr>
      <tr>
        <th>開設日</th>
        <td>平成21年4月1日</td>
...
<section class="lp-access">
  <div class="lp-access-wrap bg-gold-gradiate wrap-m space-3s space-m-bottom">
    ...
    <div class="maw-880">
      <div class="lp-gmap">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5449.981056931254!2d135.51049159411627!3d34.82842520293397!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6000fb77529dcba1%3A0x4e54b0fa7698a766!2z5pyJ5paZ6ICB5Lq644Ob44O844OgIOOCueODvOODkeODvOODu-OCs-ODvOODiOeulemdouWwj-mHjuWOnw!5e1!3m2!1sja!2sus!4v1778928066130!5m2!1sja!2sus" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
      <p class="txt-jp-l txt-medium middle txt-white mt2 mb2">阪急千里線「北千里」駅より阪急バス「小野原南」下車、徒歩約2分<br>〒562-0032　<br class="sp-only">大阪府箕面市小野原西6丁目14番15号<br>TEL：<a href="tel:0120-532-029">0120-532-029</a>（通話料無料ご入居相談窓口）</p>
...
<figure>
<img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/10/施設長写真_0018_上山%E3%80%80和彦.jpg.webp" alt="画像">
</figure>
<p class="fontM txt-just">こんにちは。
有料老人ホーム スーパー・コート プライム箕面は2010年4月1日にオープンいたしました。<br>
阪急千里線の北千里駅より徒歩18分（バスで2分）、近くには北摂で大人気の洋菓子店 （デリチュース）、また箕面の滝といった観光資源にも恵まれた有料老人ホームです。<br>
スーパー・コートではイキイキとした生活を過ごして頂けるように、ご入居者の思いに寄り添いながら、心のこもった介護、看護を行って参ります。<br>
当ホームは、パーキンソン病特化型施設として、パーキンソン病に精通した理学療法士によるリハビリテーションや神経内科専門医の訪問診療など専門医による安心の医療体制、医薬協業による薬剤師の服薬管理のサポートなどパーキンソン患者様に寄り添った取り組みも行っております。<br>
ホーム見学や入居相談等も随時行っておりますのでお近くに来られた際は、ぜひお気軽にお立ち寄りくださいませ。<br>
...
<section class="space-s space-2l-bottom bg-beige">
  <div class="lp-blog-wrap bg-white maw-960 grid align-center space-3s space-3s-bottom">
    ...
    <div>
      ...
      <p class="mt2 txt-center"><a class="lp-blog-more relative" href="https://www.supercourt.jp/blog/mino/" target="_blank">詳しく見る</a></p>
    </div>
  </div>
</section>
