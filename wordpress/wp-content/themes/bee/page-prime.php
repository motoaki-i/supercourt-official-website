...
<div class="lower-mv">
  <figure class="lower-mv-image">
    <img src="<?php bloginfo('template_directory');?>/assets/image/facility/mv_facilitylist-prime.webp" alt="">
  </figure>
...
<div class="space-2s space-2s-bottom wrap-m">病院個室以上の安心とくつろぎを。24時間看護と高度な医療対応、専門スタッフによるオーダーメイドリハビリ、天然温泉を完備。自費サービスを充実させ、質の高い介護や生きる喜びである美味しいお食事など上質な生活をご提供します。</div>

<section class="bg-beige">

<div class="wrap-m space-m">
    <h2 class="ttl-jp-2l txt-bold ttl-border-l-orange2">プライムシリーズ施設一覧</h2>

    <ul class="scarchive__list">
    <?php
    // 表示したい施設のスラッグを配列で指定
    $target_facility_slugs = [
        "kamiishi2", "onobara", "yao", "takatsuki"
    ];
...
<section id="general-point"  class="bg-beige relative space-l space-m-bottom">
  ...
  <div class="nursing-sub-ttl-l bg-yellow-gradiate wrap-m-left">
    ...
    <h2 class="ttl-jp-4l  txt-white txt-bold txt-center">スーパー・コート<br>プライムシリーズのサービス</h2>
  </div>
<br><br>
