...
<div class="lp-mv relative">
  ...
  <div class="ttl-lp-wrap bg-gold-gradiate relative">
    ...
    <h1 class="ttl-lp-jp txt-white  txt-medium">介護付き有料老人ホーム｜大阪市東成区<br>スーパー・コート プライム今里</h1>
...
<section class="scfacility-blog mt2 space-s-bottom">
    ...
    <div class="scfacility-blog__cont__wrap mt2">
        <?php
            // 表示したいブログのURLを直接指定
            $base_url = 'https://www.supercourt.jp/blog/imazato/';
    ...
    <div class="scfacility-btn__wrap">
        <?php $blog_url = 'https://www.supercourt.jp/blog/imazato/'; ?>
 ...
 */
$manual_event_slug = 'news-event-prime-imazato'; // ← ここを表示したいスラッグに書き換える
?>
...
<section id="olive-point" class="bg-beige relative">
  ...
  <div class="olive-point-wrap bg-white space-m space-3s-bottom wrap-l-right">
    ...
    <p class="bg-beige1 p1 txt-bold txt-center">※24時間看護体制は10月以降にサービス開始予定です。</p>
    </div>
...
<div class="wrap-m">
  <figure class="mb1"><img src="<?php bloginfo('template_directory');?>/assets/image/facility/prime/prime-main-meal2.webp" alt="メニュー豊かなお食事"></figure>
    <div class="mt2">
      <div class="">
...
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E4%BB%8A%E9%87%8C-18.jpg.webp" alt="外観"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">外観</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2026/06/今里_エントランス.webp" alt="エントランスホール"></figure>
...
<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2026/06/今里_リハビリスペース.webp" alt="リハビリスペース"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">リハビリスペース</h3>
</div>


<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E4%BB%8A%E9%87%8C-1.jpg.webp" alt="レストラン"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">レストラン</h3>
</div>


<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E4%BB%8A%E9%87%8C-4.jpg.webp" alt="大浴場"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">大浴場・天然温泉</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2026/06/今里_談話室.webp" alt="談話スペース"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">談話スペース</h3>
</div>


<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E4%BB%8A%E9%87%8C-17.jpg.webp" alt="駐車場"></figure>
...
<section>
  <div class="lp-price-wrap wrap-m bg-gold-gradiate space-3s space-m-bottom">
    ...
    <h3 class="ttl-jp-l txt-bold txt-center txt-white mb1">要支援・要介護（一般）プラン</h3>
    　<div class="grid2 gg1">
        ...
        <div class="bg-white txt-center p1">
          <p class="txt-medium"><span class="pi1 txt-bold">月額利用料</span><br class="sp-only"><span class="big txt-en txt-gold ">293,542</span>円（税込）</p>
        </div>
      </div>

      <div class="bg-beige1 p1 mt1">［ 入居対象 ］　要支援1　要支援2　要介護1　要介護2　要介護3　要介護4　要介護5</div>
      <p class="txt-jp-s txt-white mt1">※ご利⽤料⾦は1⽇3⾷、⾷事代含んでおります。<br>※リハビリ費用はご利⽤料⾦に含んでおります。<br>※個室内電気代が別途必要となります。<br>※介護保険、医療保険適用による負担額が別途必要となります。</p>
    </div>
  </div>


    <div>
    <h3 class="ttl-jp-l txt-bold txt-center txt-white mb1">パーキンソン病（難病）受入プラン</h3>
    <div class="grid2 gg1">
        <div class="bg-white txt-center p1">
          <p class="txt-medium"><span class="pi1 txt-bold">入居金</span><br class="sp-only"><span class="big txt-en txt-gold ">0</span>円</p>
        </div>
        <div class="bg-white txt-center p1">
          <p class="txt-medium"><span class="pi1 txt-bold">月額利用料</span><br class="sp-only"><span class="big txt-en txt-gold ">133,819</span>円（税込）</p>
        </div>
      </div>
      ...
      <p class="txt-jp-s mt1 txt-white mb2">※ご利⽤料⾦は1⽇3⾷、⾷事代含んでおります。<br>※個室内電気代が別途必要となります。<br>※介護保険、医療保険適用による負担額が別途必要となります。</p>
    </div>
...
<section class="space-m space-2l-bottom bg-beige">
  <div class="maw-880">
    ...
    <table class="facility-overview-table">
      ...
      <tr>
        <th>所在地</th>
        <td>大阪府大阪市東成区大今里西2丁目8番22号</td>
      </tr>
      <tr>
        <th>電話番号</th>
        <td>施設直通 ： <a href="tel:06-7662-4850">06-7662-4850</a><br>入居相談 ： <a href="tel:0120-532-029">0120-532-029</a></td>
      </tr>
      <tr>
        <th>規模・構造</th>
        <td>S造地上5階建</td>
      ...
      <tr>
        <th>最寄駅</th>
        <td>大阪市営地下鉄千日前線・今里筋線「今里」駅1番出口より徒歩約2分</td>
      </tr>
      <tr>
        <th>開設日</th>
        <td>平成27年10月1日</td>
...
<section class="lp-access">
  <div class="lp-access-wrap bg-gold-gradiate wrap-m space-3s space-m-bottom">
    ...
    <div class="maw-880">
      <div class="lp-gmap">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5460.473173874845!2d135.5415036!3d34.669569900000006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6000e0a100fec3bd%3A0x458c39927ac4c94f!2z5pyJ5paZ6ICB5Lq644Ob44O844OgIOOCueODvOODkeODvOODu-OCs-ODvOODiOS7iumHjA!5e1!3m2!1sja!2sjp!4v1782114310391!5m2!1sja!2sjp" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
      <p class="txt-jp-l txt-medium middle txt-white mt2 mb2">大阪市営地下鉄千日前線・今里筋線「今里」駅1番出口より徒歩約2分<br>〒537-0014　<br class="sp-only">大阪府大阪市東成区大今里西2丁目8番22号<br>TEL：<a href="tel:0120-532-029">0120-532-029</a>（通話料無料ご入居相談窓口）</p>
...
<figure>
<img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/10/%E6%96%BD%E8%A8%AD%E9%95%B7%E5%86%99%E7%9C%9F_0031_%E5%A1%A9%E5%B7%9D%E3%80%80%E8%AA%A0-240x300.jpg" alt="画像">
</figure>
<p class="fontM txt-just">介護付き有料老人ホーム スーパー・コートプライム今里は、令和8年10月1日よりプライムシリーズとして新たなサービスをご提供させていただくこととなりました。医療面では専門的なリハビリと24時間の看護体制をご提供し、生活面では食材と彩にこだわったお食事に、施設に居ながら本物の天然温泉でお寛ぎいただけます。ご自分らしい穏やかな日々を送っていただけるよう、スタッフ一同、全力でサポートいたします。皆様にお会いできる日を心よりお待ちしております。</p>
</div>
</div>
</section>
...
<section class="space-s space-2l-bottom bg-beige">
  <div class="lp-blog-wrap bg-white maw-960 grid align-center space-3s space-3s-bottom">
    ...
    <div>
      ...
      <p class="mt2 txt-center"><a class="lp-blog-more relative" href="https://www.supercourt.jp/blog/imazato/" target="_blank">詳しく見る</a></p>
    </div>
  </div>
</section>
