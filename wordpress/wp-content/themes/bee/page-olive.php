...
<div class="lower-mv">
  <figure class="lower-mv-image">
    <img src="<?php bloginfo('template_directory');?>/assets/image/facility/mv_facilitylist-olive.webp" alt="">
  </figure>
...
<div class="space-2s space-2s-bottom wrap-m">上質で落ち着きのあるデザインに、質の高い個別リハビリを実現する専用設計の老人ホームです。理学療法士ら専門職による個別リハビリ、24時間看護、服薬管理、神経内科医の訪問診療といったスーパー・コートが長年培う難病ケアへのサポート体制。天然温泉、上質なお食事、全館キレイな空気、キレイな水、ケアとホテルライクな暮らしが叶う介護施設です。</div>

<section class="bg-beige">

<div class="wrap-m space-m">
    <h2 class="ttl-jp-2l txt-bold ttl-border-l-orange2">オリーブシリーズ施設一覧</h2>

    <ul class="scarchive__list">
    <?php
    // 表示したい施設のスラッグを配列で指定
    $target_facility_slugs = [
        "olive_takarazuka", "olive_minamisenri", "facility-list-12131", "facility-list-12136", "facility-list-12132", "facility-list-12138", "facility-list-12137", "facility-list-12141", "facility-list-12139"
    ];
...
<section id="general-point"  class="bg-beige relative space-l space-m-bottom">
  ...
  <div class="nursing-sub-ttl-l bg-yellow-gradiate wrap-m-left">
    ...
    <h2 class="ttl-jp-4l  txt-white txt-bold txt-center">スーパー・コート<br>オリーブシリーズのサービス</h2>
  </div>
<br><br>
