...
<?php
// フェーズ1: 検索パラメータ取得
$search_params = sc_get_facility_search_params('area_shiga');
...
$pref_slugs = array('shiga');

// フェーズ1: meta_query構築
$meta_query = sc_build_facility_meta_query($search_params, 'area_shiga');
...
<main id="facility">
  ...
  <div class="lower-mv">
    <figure class="lower-mv-image">
      <img src="<?php bloginfo('template_directory');?>/assets/image/facility/mv.jpg"  alt="滋賀の老人ホームならスーパー・コート" class="skip-lazy">
    </figure>
    <div class="ttl-lower-wrap">
      <p class="ttl-lower-up ttl-en-2l txt-white en-upper txt-bold">facility</p>
      <h1 class="ttl-lower txt-white bg-black"><span class="ib">滋賀の老人ホーム・介護施設一覧</span></h1>
    </div>
  </div>
...
<div class="scarchive__result">
  <h2 class="scarchive__result-ttl txt-18-28 txt-bold scfacility__left-border-ttl">
    ...
    if (!empty($filter_display)) {
        echo '滋賀県の「<span class="txt-orange">' . esc_html(implode('・', $filter_display)) . '</span>」の老人ホーム・介護施設';
    } else {
        the_title();
    }
    ?>
  ...
  <div class="scarchive__result-right"></div>
      ...
      $pagination = paginate_links(array(
        ...
        'add_args' => array_filter(array(
          ...
          'area_shiga'  => !empty($search_params['area']) ? implode(',', $search_params['area']) : '',
        )),
      ));
      ...
      <div class="scarchive-feature__area scarchive-feature__wrap maw-1370 bg-white space-3s space-3s-bottom">
        <div class="scarchive-feature__inner scfacility-inner__1134">
          <div class="scfacility__bottom-border-ttl">
            <h2 class="txt-18-28 txt-bold">滋賀県の各市区町村から老人ホーム・介護施設を絞り込む</h2>
          </div>
          <ul class="scarea__list">
            <li>
              <a href="/facility-list/shiga/rittocity">
                <div class="scarea__list-image">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/image/scfacility/kusatsu.webp" alt="エリア施設">
                </div>
                <div class="scarea__list-info">
                  <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">栗東市</h3>
                  <p class="scarea__list-txt txt-13-16 lh-1_5">高速道路のインターチェンジがあり滋賀県内の草津市や大津市、京都府や大阪府とも交通の便が良い街「栗東市」。緑豊かな自然と都市機能が程よく調和しています。</p>
                  <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">栗東市の老人ホーム・介護施設一覧</div>
                </div>
              </a>
            </li>
          </ul>
...
<section class="scarchive-feature bg-beige space-m space-s-bottom">
  <div class="scarchive-feature__point scarchive-feature__wrap maw-1370 bg-white space-1 space-3s-bottom">
    <div class="scfacility-ttl scfacility-ttl--overlap txt-center">
      ...
      <h2 class="scfacility-ttl__jp txt-20-32 txt-bold txt-orange">滋賀県の老人ホーム・介護施設の特徴</h2>
    </div>
        ...
        <ul class="scarchive-feature__point-list">
          <li>
            <div class="scarchive-feature__point-image">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/image/scfacility/scarchive_point01_shiga.webp" alt="滋賀県は発展する南部と、自然豊かな北西部">
            </div>
            <div class="scarchive-feature__point-box">
              <h3 class="scarchive-feature__point-ttl scfacility__left-border-ttl txt-15-22 txt-bold">滋賀県は発展する南部と、自然豊かな北西部</h3>
              <p class="scarchive-feature__point-txt mb1">滋賀県は、日本最大の湖・琵琶湖を中心に、エリアによって老人ホームの供給状況が大きく異なります。</p>
              <dl class="mb1">
                <dt>南部エリア（大津市、草津市、守山市など）</dt>
                <dd>京都・大阪のベッドタウンとして人口増加が続いてきた地域です。利便性が高く、新しい「有料老人ホーム」や「サービス付き高齢者向け住宅」が次々と誕生しています。都市型の洗練されたサービスを求める方に人気です。</dd>
              </dl>
              <dl class="mb1">
                <dt>東部・北西部エリア（彦根市、長浜市、高島市など）</dt>
                <dd>琵琶湖を望む穏やかな環境が魅力です。地域密着型の施設が多く、のんびりとした療養生活を送るのに適していますが、南部と比較すると民間施設の選択肢が限られる傾向にあります。</dd>
              </dl>
              <dl class="mb1 bg-beige p1">
                <dt>スーパー・コートの視点</dt>
                <dd>私たちは、アクセスの良い大津・草津エリアを中心に展開しており、ご家族が「面会に来やすい」立地を重視しています。都市部の利便性を享受しつつ、滋賀らしいゆったりとした時間を提供することが私たちの役割です。</dd>
              </dl>
            </div>
          </li>
          <li>
            <div class="scarchive-feature__point-image">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/image/scfacility/scarchive_point03.webp" alt="滋賀県の人口動態と高齢化｜緩やかに、しかし着実に進む高齢社会">
            </div>
            <div class="scarchive-feature__point-box">
              <h3 class="scarchive-feature__point-ttl scfacility__left-border-ttl txt-15-22 txt-bold">滋賀県の人口動態と高齢化｜緩やかに、しかし着実に進む高齢社会</h3>
              <p class="scarchive-feature__point-txt mb1">2026年現在、滋賀県は全国平均に比べて高齢化のスピードが緩やかですが、「75歳以上の後期高齢者」の増加率は決して無視できません。</p>
              <p class="scarchive-feature__point-txt">滋賀県は「健康寿命」が長い県としても知られていますが、単身高齢世帯も増加しており、将来的な見守り体制の確保が急務となっています。</p>
            </div>
          </li>
          <li>
            <div class="scarchive-feature__point-image">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/image/scfacility/scarchive_point04.webp" alt="滋賀県の費用相場｜「近江商人」の知恵が活きる納得価格">
            </div>
            <div class="scarchive-feature__point-box">
              <h3 class="scarchive-feature__point-ttl scfacility__left-border-ttl txt-15-22 txt-bold">滋賀県の費用相場｜「近江商人」の知恵が活きる納得価格</h3>
              <p class="scarchive-feature__point-txt mb1">滋賀県の大きな魅力の一つは、「コストパフォーマンスの高さ」です。京都や大阪の都心部と比較すると、同じ予算でワンランク上の設備やサービスを受けられることが多々あります。</p>
              <dl class="mb1">
                <dt>費用の目安</dt>
                <dd>入居一時金は0円から数百万円、月額利用料は14万円〜20万円程度が主流です。</dd>
              </dl>
              <dl class="mb1">
                <dt>経済観念</dt>
                <dd>「三方よし（売り手よし、買い手よし、世間よし）」の精神が根付く滋賀では、価格に見合った、あるいはそれ以上の価値があるサービスが厳しく吟味されます。</dd>
              </dl>
              <p class="mb1 bg-beige p1">スーパー・コートでも、過度な贅沢を排しつつも、ご入居者様の喜び（天然温泉や美味しい食事）には妥協しない、滋賀の皆様に納得いただける価格設定を追求しています。</p>
            </div>
          </li>
          <li>
            <div class="scarchive-feature__point-image">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/image/scfacility/scarchive_point05_shiga.webp" alt="滋賀県独自の介護予防は口腔から健康を守る「健口体操」">
            </div>
            <div class="scarchive-feature__point-box">
              <h3 class="scarchive-feature__point-ttl scfacility__left-border-ttl txt-15-22 txt-bold">滋賀県独自の介護予防は口腔から健康を守る「健口体操」</h3>
              <p class="scarchive-feature__point-txt mb1">滋賀県が特に力を入れているのが、お口の健康から全身の活力を維持する「口腔機能向上」です。</p>
              <dl class="mb1">
                <dt>健口体操</dt>
                <dd>県が開発したプログラムで、誤嚥（ごえん）性肺炎の予防や、美味しく食べるための機能を維持します。</dd>
              </dl>
              <dl class="mb1">
                <dt>フレイル予防</dt>
                <dd>各市町で配布される「介護予防リーフレット」を活用し、住民主体の活動が盛んです。</dd>
              </dl>
              <p class="mb1 bg-beige p1">スーパー・コートでは、こうした行政の取り組みに合わせ、専門スタッフによる機能訓練や、五感を刺激するレクリエーションを日常的に取り入れています。</p>
            </div>
          </li>
          <li>
            <div class="scarchive-feature__point-image">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/image/scfacility/scarchive_point06_shiga.webp" alt="滋賀県の地域包括ケアと高齢者の住まい">
            </div>
            <div class="scarchive-feature__point-box">
              <h3 class="scarchive-feature__point-ttl scfacility__left-border-ttl txt-15-22 txt-bold">滋賀県の地域包括ケアと高齢者の住まい</h3>
              <p class="scarchive-feature__point-txt mb1">滋賀県では2025年以降のさらなる高齢化を見据え、「地域包括ケアシステム」の深化を進めています。</p>
              <dl class="mb1">
                <dt>シルバーハウジングの増設</dt>
                <dd>バリアフリー化された公営住宅の整備。</dd>
              </dl>
              <dl class="mb1">
                <dt>多機関連携</dt>
                <dd>地域包括支援センターを中心に、医師会やボランティア団体が一体となって「在宅」と「施設」の垣根を低くする取り組みが行われています。</dd>
              </dl>
            </div>
          </li>
          <li>
            <div class="scarchive-feature__point-image">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/image/scfacility/scarchive_point02_shiga.webp" alt="滋賀県の介護相談・苦情解決「あんしん・なっとく委員会」">
            </div>
            <div class="scarchive-feature__point-box">
              <h3 class="scarchive-feature__point-ttl scfacility__left-border-ttl txt-15-22 txt-bold">滋賀県の介護相談・苦情解決「あんしん・なっとく委員会」</h3>
              <p class="scarchive-feature__point-txt mb1">安心して介護サービスを利用し続けるために、滋賀県には独自の名称を持つ相談窓口があります。</p>
              <dl class="mb1">
                <dt>あんしん・なっとく委員会（滋賀県運営適正化委員会）</dt>
                <dd>滋賀県社会福祉協議会内に設置されており、医師や弁護士などの専門家が、利用者と事業者の間に入ってトラブルの解決（あっせん）を図ります。</dd>
              </dl>
              <dl class="mb1">
                <dt>国保連（国民健康保険団体連合会）</dt>
                <dd>介護保険サービスに関する正式な苦情申し立てを受け付けています。</dd>
              </dl>
            </div>
          </li>
        </ul>
  ...
  <section class="scarchive-reason space-m space-m-bottom bg-white">
    <div class="scarchive-reason__wrap wrap-m maw-960">
      <div class="scfacility-ttl txt-center">
        ...
        <h2 class="scfacility-ttl__jp txt-20-32 txt-bold txt-orange">スーパー・コートが滋賀県で<br class="sp-only">選ばれる理由</h2>
      </div>
      ...
      <ul class="scarchive-match__list">
        <li class="bg-white space-1">
          <div class="scfacility-ttl scfacility-ttl--overlap txt-center">
            ...
            <h2 class="scfacility-ttl__jp txt-20-32 txt-bold txt-orange">あなたにピッタリの<br>スーパー・コートの滋賀県の施設</h2>
          </div>
  ...
  <section class="scarchive-cost bg-beige space-s space-m-bottom">
    <div class="scarchive-cost__wrap wrap-m space-1 bg-white">
      <div class="scfacility-ttl scfacility-ttl--overlap txt-center">
        ...
        <h2 class="scfacility-ttl__jp txt-20-32 txt-bold txt-orange">滋賀県の老人ホーム・<br class="sp-only">介護施設の<br>費用の解説</h2>
      </div>
      <div class="scarchive-cost__inner scfacility-inner__960">
        <ul class="scarchive-cost__list lh-1_75">
          ...
          <li>
            <h3 class="scarchive-cost__list-ttl scfacility__left-border-ttl lh-1_45 txt-bold">滋賀県の高齢者向け助成金・補助金</h3>
            <p class="scarchive-cost__list-txt txt-13-16 txt-just">滋賀県は「健康寿命の延伸」を掲げ、各自治体がきめ細やかな高齢者支援を行っています。<br><span class="txt-medium">高額介護合算療養費制度</span>： 介護保険と医療保険の両方の自己負担が高額になった場合、合算して限度額を超えた分が支給される制度です。<br><span class="txt-medium">寝たきり高齢者等紙おむつ給付</span>： 大津市や草津市をはじめ、県内多くの自治体でオムツ代の助成や現物支給が行われています。<br><span class="txt-medium">住宅改修費の支給</span>： ご入居前の自宅環境整備等において、介護保険を利用した改修費補助が受けられる場合があります。</p>
            <p class="txt-12-14 lh-1_45 mt1">※制度の利用には申請が必要です。詳細は各市町の担当課へご確認ください。</p>
          </li>
        </ul>
