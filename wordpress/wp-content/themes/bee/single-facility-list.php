         ...
         <div class="content ">
            <ol class="information_wrapper">
               ...
               <div class="column-time">
                  <span title="公開日">
                     <i class="material-icons access_time_filled"></i>公開日：<time itemprop="datePublished" datetime="<?php the_time('Y-m-d');?>"><?php the_time('Y-m-d');?></time>
                  </span>
               </div>
               <div class="column-time">
                  <span title="更新日">
                     <i class="material-icons loop"></i>更新日：<time itemprop="dateModified" datetime="<?php the_modified_date('Y-m-d');?>"><?php the_modified_date('Y-m-d'); ?></time>
                  </span>
               </div>
            </div>
            </ol>
            ...
            <div class="topics-content">
               <?php the_content(); ?>
               <?php echo do_shortcode('[sc name="supervision"][/sc]'); ?>
            </div>
