...
<div class="lp-mv relative">
  ...
  <div class="ttl-lp-wrap bg-gold-gradiate relative">
    ...
    <h1 class="ttl-lp-jp txt-white  txt-medium">介護付き有料老人ホーム｜八尾市<br>スーパー・コート プライム八尾</h1>
    <p class="ttl-lp-open">2026年<br><span>9</span>月<br>プライム施設へ<br>リニューアル</p>
  </div>
</div>
...
<section class="scfacility-blog mt2 space-s-bottom">
    ...
    <div class="scfacility-blog__cont__wrap mt2">
        <?php
            // 表示したいブログのURLを直接指定
            $base_url = 'https://www.supercourt.jp/blog/yao/';
    ...
    <div class="scfacility-btn__wrap">
        <?php $blog_url = 'https://www.supercourt.jp/blog/yao/'; ?>
 ...
 */
$manual_event_slug = 'news-event-prime-yao'; // ← ここを表示したいスラッグに書き換える
?>
...
<section id="olive-point" class="bg-beige relative">
  ...
  <div class="olive-point-wrap bg-white space-m space-3s-bottom wrap-l-right">
    ...
    <p class="bg-beige1 p1 txt-bold txt-center">※24時間看護体制、専門職による個別リハビリは9月以降にサービス開始予定です。</p>
    </div>
  ...
  <figure class="mb1"><img src="<?php bloginfo('template_directory');?>/assets/image/facility/prime/prime-main-nursing.webp" alt="専門リハビリ"></figure>
    <div class="mt2">
      <div class="">
        ...
        <p class="bg-beige1 p1">痰吸引や胃瘻などの処置が必要な方でも安心してご利用いただけます。<br><span class="txt-bold">※24時間看護体制は9月以降にサービス開始予定です。</span></p>
    </div>
    </div>
</div>
</section>
  ...
  <figure class="mb1"><img src="<?php bloginfo('template_directory');?>/assets/image/facility/prime/prime-main-rihabiti.webp" alt="専門リハビリ"></figure>
    <div class="mt2">
      <div class="">
        ...
        <p class="bg-beige1 p1">理学療法士監修によるリハビリをご提供いたします。退院(入居)後、30日間は週5回、31日目以降は週3回リハビリを受けることができます。<br><span class="txt-bold">※専門職による個別リハビリは9月以降にサービス開始予定です。</span></p>
...
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E5%85%AB%E5%B0%BE-12.jpg.webp" alt="外観"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">外観</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E5%85%AB%E5%B0%BE-9.jpg.webp" alt="エントランスホール"></figure>
...
<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E5%85%AB%E5%B0%BE-1.jpg.webp" alt="レストラン"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">レストラン</h3>
</div>


<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/11/%E5%85%AB%E5%B0%BE-13.jpg.webp" alt="大浴場"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">大浴場・天然温泉</h3>
</div>

<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2026/06/八尾_談話スペース.webp" alt="談話スペース"></figure>
<h3 class="ttl-jp-m txt-medium mt1 mb1">談話スペース</h3>
</div>


<div class="olive-kodawari-item">
<figure><img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2026/06/八尾_駐車場.webp" alt="駐車場"></figure>
...
<section>
  <div class="lp-price-wrap wrap-m bg-gold-gradiate space-3s space-m-bottom">
    ...
    　<div class="grid2 gg1">
        ...
        <div class="bg-white txt-center p1">
          <p class="txt-medium"><span class="pi1 txt-bold">月額利用料</span><br class="sp-only"><span class="big txt-en txt-gold ">276,896</span>円（税込）</p>
        </div>
      </div>
...
<section class="space-m space-2l-bottom bg-beige">
  <div class="maw-880">
    ...
    <table class="facility-overview-table">
      ...
      <tr>
        <th>所在地</th>
        <td>大阪府八尾市北亀井町3丁目2番31号</td>
      </tr>
      <tr>
        <th>電話番号</th>
        <td>施設直通 ： <a href="tel:072-929-4850">072-929-4850</a><br>入居相談 ： <a href="tel:0120-532-029">0120-532-029</a></td>
      </tr>
      <tr>
        <th>規模・構造</th>
        <td>鉄筋コンクリート造地上３階建</td>
      </tr>
      <tr>
        <th>居室数</th>
        <td>60室</td>
      ...
      <tr>
        <th>最寄駅</th>
        <td>JR大和路線「久宝寺」駅南側出口より徒歩約11分</td>
      </tr>
      <tr>
        <th>開設日</th>
        <td>平成19年5月1日</td>
...
<section class="lp-access">
  <div class="lp-access-wrap bg-gold-gradiate wrap-m space-3s space-m-bottom">
    ...
    <div class="maw-880">
      <div class="lp-gmap">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5463.659597572313!2d135.57316417722603!3d34.62119987294823!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6000df3a6c4b9dc5%3A0x7871606cde9b91ba!2z5pyJ5paZ6ICB5Lq644Ob44O844OgIOOCueODvOODkeODvOODu-OCs-ODvOODiOWFq-Wwvg!5e1!3m2!1sja!2sjp!4v1782119556948!5m2!1sja!2sjp" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
      <p class="txt-jp-l txt-medium middle txt-white mt2 mb2">JR大和路線「久宝寺」駅南側出口より徒歩約11分<br>〒581-0066　<br class="sp-only">大阪府八尾市北亀井町3丁目2番31号<br>TEL：<a href="tel:0120-532-029">0120-532-029</a>（通話料無料ご入居相談窓口）</p>
...
<figure>
<img src="https://www.supercourt.jp/wordpress/wp-content/uploads/2023/10/%E6%96%BD%E8%A8%AD%E9%95%B7%E5%86%99%E7%9C%9F_0016_%E6%9D%BE%E8%B0%B7%E3%80%80%E7%9B%B4%E5%B7%B1-240x300.jpg" alt="画像">
</figure>
<p class="fontM txt-just">介護付き有料老人ホーム スーパー・コートプライム八尾は、令和8年9月1日よりプライムシリーズとして新たなサービスをご提供させていただくこととなりました。医療面では専門的なリハビリと24時間の看護体制をご提供し、生活面では食材と彩にこだわったお食事に、施設に居ながら本物の天然温泉でお寛ぎいただけます。ご自分らしい穏やかな日々を送っていただけるよう、スタッフ一同、全力でサポートいたします。皆様にお会いできる日を心よりお待ちしております。</p>
</div>
</div>
</section>
...
<section class="space-s space-2l-bottom bg-beige">
  <div class="lp-blog-wrap bg-white maw-960 grid align-center space-3s space-3s-bottom">
    ...
    <div>
      ...
      <p class="mt2 txt-center"><a class="lp-blog-more relative" href="https://www.supercourt.jp/blog/yao/" target="_blank">詳しく見る</a></p>
    </div>
  </div>
</section>
