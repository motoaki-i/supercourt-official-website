...
<?php
// フェーズ1: 検索パラメータ取得
$search_params = sc_get_facility_search_params('area_osaka');
...
// フェーズ1: meta_query構築
$meta_query = sc_build_facility_meta_query($search_params, 'area_osaka');
...
<main id="facility">
  ...
  <div class="lower-mv">
    <figure class="lower-mv-image">
      <img src="<?php bloginfo('template_directory');?>/assets/image/facility/mv.jpg" alt="大阪の老人ホームならスーパー・コート" class="skip-lazy">
    </figure>
    <div class="ttl-lower-wrap">
      <p class="ttl-lower-up ttl-en-2l txt-white en-upper txt-bold">facility</p>
      <h1 class="ttl-lower txt-white bg-black"><span class="ib">大阪の老人ホーム・介護施設一覧</span></h1>
    </div>
  </div>
...
<div class="breadcrumbs-container">
  ...
  get_template_part('template-parts/facility-search-form', null, array(
    ...
    'area_field_name'     => 'area_osaka',
    'area_label'          => '市区町村（大阪）',
  ));
  ?>

  <section class="scarchive space-s space-s-bottom bg-beige">
...
<div class="scarchive__result">
  <h2 class="scarchive__result-ttl txt-18-28 txt-bold scfacility__left-border-ttl">
    ...
    $area_labels = [
        'osakacity' => '大阪市', 'sakaicity' => '堺市', 'higashiosakacity' => '東大阪市',
        'toyonakacity' => '豊中市', 'takatsukicity' => '高槻市', 'suitacity' => '吹田市',
        'ibarakicity' => '茨木市', 'ikedacity' => '池田市', 'minoocity' => '箕面市',
        'kadomacity' => '門真市', 'daitocity' => '大東市', 'yaocity' => '八尾市',
        'matsubaracity' => '松原市', 'takaishicity' => '高石市'
    ];
    ...
    if (!empty($filter_display)) {
        echo '大阪府の「<span class="txt-orange">' . esc_html(implode('・', $filter_display)) . '</span>」の老人ホーム・介護施設';
    } else {
        the_title();
    }
    ?>
  ...
  <div class="scarchive__result-right"></div>
      ...
      $pagination = paginate_links(array(
        ...
        'add_args' => array_filter(array(
          ...
          'area_osaka'  => !empty($search_params['area']) ? implode(',', $search_params['area']) : '',
        )),
      ));
  ...
  <div class="scarchive-feature__area scarchive-feature__wrap maw-1370 bg-white space-3s space-3s-bottom">
    <div class="scarchive-feature__inner scfacility-inner__1134">
      <div class="scfacility__bottom-border-ttl">
        <h2 class="txt-18-28 txt-bold lh-1_4">大阪府の各市区町村から老人ホーム・介護施設を絞り込む</h2>
      </div>
        ...
        <li>
          <a href="/facility-list/osaka/osakacity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">大阪市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">商業施設や高度医療機関が充実した西日本最大の都市「大阪市」。交通の便が非常に良く、都会的な利便性と安心感が両立するエリアです。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">大阪市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
        <li>
          <a href="/facility-list/osaka/sakaicity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">堺市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">世界遺産・百舌鳥古墳群を有する政令指定都市「堺市」。歴史的な風情と都市機能が融合し、医療や福祉も充実した住みよい街です。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">堺市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
        <li>
          <a href="/facility-list/osaka/higashiosakacity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">東大阪市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">モノづくりの街としての活気と、ラグビーの聖地としての顔を持つ元気な街「東大阪市」。人情味あふれる温かい雰囲気が魅力です。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">東大阪市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
        <li>
          <a href="/facility-list/osaka/toyonakacity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">豊中市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">大阪都心へのアクセスが良く、服部緑地など緑豊かな公園も点在する「豊中市」。北摂エリアを代表する、閑静で人気のある住宅都市です。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">豊中市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
        <li>
          <a href="/facility-list/osaka/takatsukicity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">高槻市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">大阪と京都のちょうど中間に位置し、両方面へのアクセスが抜群の「高槻市」。駅周辺の賑わいと自然が共存する、暮らしやすい街です。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">高槻市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
        <li>
          <a href="/facility-list/osaka/suitacity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">吹田市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">万博記念公園などの自然と、国立循環器病研究センターなどの医療都市機能が調和する「吹田市」。住環境と安心の医療が揃う街です。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">吹田市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
        <li>
          <a href="/facility-list/osaka/ibarakicity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">茨木市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">大学や文化施設が多い文教都市「茨木市」。整備された美しい街並みと、京都・大阪へスムーズに移動できる利便性が人気です。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">茨木市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
        <li>
          <a href="/facility-list/osaka/ikedacity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">池田市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">五月山や猪名川など自然に恵まれた歴史ある庭園都市「池田市」。大阪空港へのアクセスも良く、文化的な薫りと静けさが漂います。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">池田市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
        <li>
          <a href="/facility-list/osaka/minoocity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">箕面市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">箕面大滝などの豊かな自然と、落ち着いた街並みが魅力の「箕面市」。四季の移ろいを感じながら、ゆったりと心豊かに暮らせるエリアです。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">箕面市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
        <li>
          <a href="/facility-list/osaka/kadomacity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">門真市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">大阪市内へのアクセスが良好で、生活利便施設が充実する「門真市」。下町情緒が残る親しみやすい雰囲気の中で安心して暮らせます。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">門真市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
        <li>
          <a href="/facility-list/osaka/daitocity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">大東市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">飯盛山の麓に広がり、歴史と自然が息づく街「大東市」。大阪市内へのアクセスも良く、落ち着いた環境で穏やかに過ごせます。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">大東市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
        <li>
          <a href="/facility-list/osaka/yaocity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">八尾市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">河内音頭の故郷として知られる歴史ある街「八尾市」。大型ショッピングモールなどの買い物環境も整い、生活の利便性が高いエリアです。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">八尾市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
        <li>
          <a href="/facility-list/osaka/matsubaracity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">松原市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">大阪市に隣接し、南大阪の交通の要衝として発展する「松原市」。活気ある商店街や親しみやすい地域性が魅力の、温かい街です。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">松原市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
        <li>
          <a href="/facility-list/osaka/takaishicity">
            ...
            <div class="scarea__list-info">
              <h3 class="scarea__list-ttl scfacility__left-border-ttl txt-bold lh-1_5">高石市</h3>
              <p class="scarea__list-txt txt-13-16 lh-1_5">大阪湾に面し、浜寺公園などの美しい松林があるコンパクトな街「高石市」。平坦な地形が多く、高齢者にも優しい住環境です。</p>
              <div class="scarea__list-btn txt-12-14 txt-bold lh-1_5 txt-white bg-orange-gradiate-reverse">高石市の老人ホーム・介護施設一覧</div>
            </div>
          </a>
        </li>
      </ul>
...
<section class="scarchive-feature bg-beige space-m space-l-bottom">
  ...
  <div class="scarchive-feature__point scarchive-feature__wrap maw-1370 bg-white space-1 space-3s-bottom">
    <div class="scfacility-ttl scfacility-ttl--overlap txt-center">
      ...
      <h2 class="scfacility-ttl__jp txt-20-32 txt-bold txt-orange">大阪府の老人ホーム・介護施設の特徴</h2>
    </div>
      ...
      <ul class="scarchive-feature__point-list">
        <li>
          <div class="scarchive-feature__point-image">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/image/scfacility/scarchive_point01_osaka.webp" alt="老人ホーム市場の特色">
          </div>
          <div class="scarchive-feature__point-box">
            <h3 class="scarchive-feature__point-ttl scfacility__left-border-ttl txt-15-22 txt-bold">西日本最大級の供給数<br>大阪府の老人ホーム市場の二極化</h3>
            <p class="scarchive-feature__point-txt mb1">大阪府は、東京都に次ぐ日本第二の都市であり、高齢者人口の多さに比例して老人ホームの選択肢も非常に豊富です。しかし、その市場は「エリア」と「価格帯」による二極化が顕著に進んでいます。</p>
            <dl class="mb1">
              <dt>北摂・北河内エリア（豊中市、吹田市、枚方市など）</dt>
              <dd>古くからの住宅街が多く、富裕層向けの「介護付有料老人ホーム」が集中しています。入居一時金が数千万円に達する高級施設から、手厚い人員配置を売りにする施設まで、質を重視する層に選ばれています。</dd>
            </dl>
            <dl class="mb1">
              <dt>大阪市内エリア</dt>
              <dd>近年、オフィス街や商業エリアの再開発に伴い、都市型老人ホームや「サービス付き高齢者向け住宅（サ高住）」が急増しています。利便性が高く、現役世代のご家族が仕事帰りに面会へ立ち寄りやすいのが特徴です。</dd>
            </dl>
            <dl class="mb1">
              <dt>堺市・泉州・南河内エリア</dt>
              <dd>比較的広大な敷地を確保した施設が多く、月額利用料を抑えた「住宅型有料老人ホーム」の供給が目立ちます。コストパフォーマンスを重視し、ゆったりとした環境を求める方に適したエリアです。</dd>
            </dl>
            <dl class="mb1 bg-beige p1">
              <dt>スーパー・コートの視点</dt>
              <dd>大阪府下で多数の施設を展開する私たちは、地域ごとの地価やニーズを熟知しています。「住み慣れた地域で、その方らしい暮らしを」という理念のもと、都市部でも負担を抑えつつ高品質なサービスを提供できるよう、効率的で温かみのある運営を追求しています。</dd>
            </dl>
          </div>
        </li>
        <li>
          <div class="scarchive-feature__point-image">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/image/scfacility/scarchive_point03.webp" alt="大阪府のデータで見る「超高齢社会」の現状">
          </div>
          <div class="scarchive-feature__point-box">
            <h3 class="scarchive-feature__point-ttl scfacility__left-border-ttl txt-15-22 txt-bold">大阪府のデータで見る「超高齢社会」の現状</h3>
            <p class="scarchive-feature__point-txt mb1">2024年度（令和6年度）から始まった「第9期大阪府高齢者計画」に基づくと、大阪府の高齢化率は全国平均（約29%）を下回る約28%前後で推移していますが、深刻なのは「75歳以上の後期高齢者」の急増です。</p>
            <dl class="mb1">
              <dt>認定者数の増加</dt>
              <dd>大阪府内の要介護・要支援認定者数は約55万人を超え、特に都市部での伸びが顕著です。</dd>
            </dl>
            <dl class="mb1">
              <dt>単身世帯の課題</dt>
              <dd>大阪市を中心に「独居高齢者」の割合が高く、急病時の対応や孤独死の防止が大きな社会課題となっています。このため、24時間スタッフが常駐する老人ホームへのニーズは、単なる「介護」から「安心の確保」へとシフトしています。</dd>
            </dl>
          </div>
        </li>
        <li>
          <div class="scarchive-feature__point-image">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/image/scfacility/scarchive_point04.webp" alt="費用相場の実態｜大阪で「納得の価格」を見極めるには">
          </div>
          <div class="scarchive-feature__point-box">
            <h3 class="scarchive-feature__point-ttl scfacility__left-border-ttl txt-15-22 txt-bold">費用相場の実態｜大阪で「納得の価格」を見極めるには</h3>
            <p class="scarchive-feature__point-txt mb1">大阪府の老人ホーム費用は、エリアとサービス内容で大きく変動します。</p>
            <p class="scarchive-feature__point-txt mb1">※上記は一般的な目安であり、施設の種類（介護付・住宅型・サ高住）により異なります。</p>
            <p class="mb1 bg-beige p1">大阪では「入居一時金0円プラン」を用意している施設も多く、初期費用を抑えたいニーズに応えています。スーパー・コートでも、入居時の負担を軽減しつつ、毎月の支払いを明確にすることで、長期にわたる安心した生活をサポートしています。</p>
          </div>
        </li>
        <li>
          <div class="scarchive-feature__point-image">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/image/scfacility/scarchive_point05_osaka.webp" alt="大阪府の医療連携と「看取り」への対応">
          </div>
          <div class="scarchive-feature__point-box">
            <h3 class="scarchive-feature__point-ttl scfacility__left-border-ttl txt-15-22 txt-bold">大阪府の医療連携と「看取り」への対応</h3>
            <p class="scarchive-feature__point-txt mb1">大阪府は「大阪大学医学部附属病院」を筆頭に、高度な医療機関が集積している地域です。老人ホーム選びにおいても、「どの病院と、どのような連携をとっているか」は極めて重要な判断基準です。<br>昨今のトレンドとして、大阪府内でも「終の棲家（ついのすみか）」として老人ホームを選ぶ方が増えており、がん末期や難病の方を受け入れる「ホスピス型」のニーズも高まっています。</p>
            <dl class="mb1 bg-beige p1">
              <dt>スーパー・コートの強み</dt>
              <dd>私たちは地域の協力医療機関との緊密な連携に加え、一部施設では24時間看護体制を整え、重度の介護状態や医療的ケアが必要な方の受け入れも積極的に行っています。</dd>
            </dl>
          </div>
        </li>
        <li>
          <div class="scarchive-feature__point-image">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/image/scfacility/scarchive_point06_osaka.webp" alt="大阪らしい「活気」と「自立支援」の両立">
          </div>
          <div class="scarchive-feature__point-box">
            <h3 class="scarchive-feature__point-ttl scfacility__left-border-ttl txt-15-22 txt-bold">大阪らしい「活気」と「自立支援」の両立</h3>
            <p class="scarchive-feature__point-txt mb1">大阪の高齢者は、人との交流や「笑い」を大切にする文化を持っています。施設内でのレクリエーションの質が、入居者様のQOL（生活の質）に直結します。<br>また、大阪府が推進する「健活10（ケンカツ テン）」に見られるように、介護予防への関心も高まっています。 </p>
            <p class="mb1 bg-beige p1">スーパー・コートでは、ただ保護するだけの介護ではなく、「自立支援」に重きを置いています。</p>
            <dl class="mb1">
              <dt>天然温泉の活用</dt>
              <dd>スーパー・コートでは天然温泉を引き込み、リラックス効果と共に、血行促進によるリハビリ効果を狙っています。</dd>
            </dl>
            <dl class="mb1">
              <dt>独自の機能訓練</dt>
              <dd>スーパー・コートでは「歩く」「食べる」といった基本動作の維持・改善をサポートするプログラムを、大阪の元気な高齢者の皆様に提供しています。</dd>
            </dl>
          </div>
        </li>
        <li>
          <div class="scarchive-feature__point-image">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/image/scfacility/scarchive_point02_osaka.webp" alt="大阪府の相談窓口と権利擁護">
          </div>
          <div class="scarchive-feature__point-box">
            <h3 class="scarchive-feature__point-ttl scfacility__left-border-ttl txt-15-22 txt-bold">大阪府の相談窓口</h3>
            <p class="scarchive-feature__point-txt mb1">大阪府内で施設探しに迷った際、あるいは入居後に相談したい場合の公的な窓口も充実しています。</p>
            <dl class="mb1">
              <dt>地域包括支援センター</dt>
              <dd>市町村ごとに設置されており、介護保険申請の前段階から相談が可能です。</dd>
            </dl>
            <dl class="mb1">
              <dt>大阪府運営適正化委員会（大阪府社会福祉協議会内）</dt>
              <dd>福祉サービスに関する苦情を、第三者の立場で解決する専門委員会です。</dd>
            </dl>
            <dl class="mb1">
              <dt>高齢者住宅相談窓口</dt>
              <dd>大阪府独自の取り組みとして、高齢者が安心して住宅を確保できるよう、情報の提供を行っています。</dd>
            </dl>
          </div>
        </li>
      </ul>
  ...
  <section class="scarchive-reason space-m space-m-bottom bg-white">
    <div class="scarchive-reason__wrap wrap-m maw-960">
      <div class="scfacility-ttl txt-center">
        ...
        <h2 class="scfacility-ttl__jp txt-20-32 txt-bold txt-orange">スーパー・コートが大阪府で<br class="sp-only">選ばれる理由</h2>
      </div>
      ...
      <ul class="scarchive-match__list">
        <li class="bg-white space-1">
          <div class="scfacility-ttl scfacility-ttl--overlap txt-center">
            ...
            <h2 class="scfacility-ttl__jp txt-20-32 txt-bold txt-orange">あなたにピッタリの<br>スーパー・コートの大阪府の施設</h2>
          </div>
  ...
  <section class="scarchive-cost bg-beige space-s space-m-bottom">
    <div class="scarchive-cost__wrap wrap-m space-1 bg-white">
      <div class="scfacility-ttl scfacility-ttl--overlap txt-center">
        ...
        <h2 class="scfacility-ttl__jp txt-20-32 txt-bold txt-orange">大阪府の老人ホーム・<br class="sp-only">介護施設の<br>費用の解説</h2>
      </div>
      <div class="scarchive-cost__inner scfacility-inner__960">
        <ul class="scarchive-cost__list lh-1_75">
          ...
          <li>
            <h3 class="scarchive-cost__list-ttl scfacility__left-border-ttl lh-1_45 txt-bold">大阪府の高齢者向け助成金・補助金</h3>
            <p class="scarchive-cost__list-txt txt-13-16 txt-just">大阪府内の各自治体では、高齢者の生活を支える様々な助成制度が設けられています。<br><span class="txt-medium">高額介護サービス費の支給</span>： 1ヶ月の介護保険自己負担額が上限を超えた場合、超過分が払い戻される制度です。<br><span class="txt-medium">高齢者住宅改修費用助成</span>： 自宅の手すり設置などの改修費用を給付する制度ですが、施設入居前や、在宅復帰を検討される際に活用できる場合があります。<br><span class="txt-medium">オムツ給付事業助成</span>： 大阪市をはじめ多くの市町村で、要介護認定を受けた方を対象に紙オムツの支給や購入費助成を行っています。</p>
            <p class="txt-12-14 lh-1_45 mt1">※詳細な条件や対象については、各市町村の窓口やケアマネジャーにご相談ください。</p>
          </li>
        </ul>
  ...
  <!-- <section class="scfacility-voice space-3s space-2s-bottom">
		<div class="scfacility-voice__wrap wrap-m">
			<div class="scfacility-ttl txt-center">
				...
				<h2 class="scfacility-ttl__jp txt-20-32 txt-bold txt-orange">大阪の老人ホーム・<br>介護施設のご入居者の声</h2>
			</div>
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (firstFacility) {
        ...
        const peekHeight = window.innerWidth < 768 ? 320 : 360; // スマホ80px / PC120px見せる
