...
#06.設置者のアドレス(カンマ区切り)
$conf{'mailto'} = 'supercourt@supercourt.co.jp,it@supercourt.co.jp';

#07.送信完了時にリダイレクトするサンクスページ
$conf{'thanks'} = 'https://www.supercourt.jp/data_request_dl/thanks.html';

#08.設置者に届くメールの件名
$conf{'subject'} = '資料ダウンロードフォームからメールがありました';

#09.送信者に届くメールの件名
$conf{'res_subject'} = '資料ダウンロードを受け付けました【スーパー・コート】';

#10.送信者に届くメールの本文
$conf{'res_body'} = <<'__res_body_eof__';
スーパー・コートへお問い合わせ頂き誠にありがとうございます。
施設の資料ダウンロードページをご案内いたします。
下記の【ダウンロードページはこちら】のURLにアクセスして、
資料をダウンロードしてください。

▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼
【ダウンロードページはこちら】
https://www.supercourt.jp/data_request_dl/download.html
▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲
...
この度は資料ダウンロードをお申し込みいただき重ねてお礼申し上げます。
━━━━━━━━━━━━━━━━━━━━━━━━━━
　〒550－0005 
　大阪市西区西本町1丁目7番7号 CE西本町ビル
　株式会社スーパー・コート
━━━━━━━━━━━━━━━━━━━━━━━━━━
__res_body_eof__
...
$posted_body = sprintf("%04d年%02d月%02d日 %02d:%02d\n",$year,$mon,$day,$hour,$min,$sec);
$conf{'download_file_name'} = sprintf("%04d-%02d-%02d.csv",$year,$mon,$day,$hour,$min,$sec);
push @field, "DATE";
push @record, sprintf("%04d年%02d月%02d日　%02d時%02d分%02d秒",$year,$mon,$day,$hour,$min,$sec);
...
sub send {
	if(&spamcheck){
		if(!$conf{'debug'}){
			...
			if(@mailto > 0){
				&serials;
				if($mailfrom =~ /[^a-zA-Z0-9\.\@\-\_\+]/ || split(/\@/,$mailfrom) != 1){
					$mailfrom = $mailto[0];
				}
