$(function(){
	...
	$(".js-gallery").slick({
		arrows: true,
		prevArrow: ' <button type="button" class="slick-prev slick-arrow--skin1">‹</button>',
		nextArrow: ' <button type="button" class="slick-next slick-arrow--skin1">›</button>',
		dots: true,
		centerMode: true,
		centerPadding: "20%",
		responsive: [
	...
	$(".js-floor").slick({
		arrows: true,
		prevArrow: ' <button type="button" class="slick-prev slick-arrow--skin2">〈</button>',
		nextArrow: ' <button type="button" class="slick-next slick-arrow--skin2">〉</button>',
		dots: true
	});
