...
$(function () {
  var facility_item_scroll = ".area-contents__facility-jsScroll";
  var map_img_text = ".area-contents__map-img-text";
  function js_scroll_active() {
    $(facility_item_scroll).jScrollPane();
  }
  ...
  $(map_img_text).on("click", function (e) {
    js_scroll_active();
  });
  $(".area-contents__area-button").on("click", function (e) {
    js_scroll_active();
  });
});
