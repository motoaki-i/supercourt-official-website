  ...
  a.validationEngineLanguage = {
    newLang: function () {
      a.validationEngineLanguage.allRules = {
        ...
        phone: {
          regex: /^([0-9]{2,4})?([-]{0,1})?([0-9]{2,4})?([-]{0,1})?([0-9]{4})((x|ext|extension)[ ]?[0-9]{10,11})?$/,
          alertText: "* 電話番号が正しくありません"
        },
        yubin: {
          regex: /^([0-9]{3})?([-]{0,1})?([0-9]{4})((x|ext|extension)[ ]?[0-9]{7,8})?$/,
        ...
        number: {
          ...
          alertText: "* 0から9までの数字のみを入力してください"
        },
        date: {
